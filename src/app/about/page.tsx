export default function About() {
  return (
    ...
    <div className="max-w-4xl w-full">
      <h1 className="text-4xl font-bold text-center mb-4 mt-24 underline text-cyan-300 animate-scale-up-down">About Me</h1>
      
      <div className="bg-slate-200 shadow-xl shadow-background px-4 py-8 animate-slide-in rounded-xl p-4">
