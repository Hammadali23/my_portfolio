export default function About() {
  return (
    <div className="bg-slate-600 min-h-screen flex flex-col items-center pt-4 py-12 px-4 dark:bg-gray-900 dark:text-white">
      <div className="max-w-4xl w-full">
        <h1 className="text-4xl font-bold text-center mb-4 mt-24 underline text-cyan-300 animate-scale-up-down">
          About Me
        </h1>
        
        <div className="bg-slate-200 shadow-xl shadow-background px-4 py-8 animate-slide-in rounded-xl p-4 dark:bg-gray-800 dark:shadow-md">
          <h2 className="text-3xl font-semibold text-blue-900 mb-2 dark:text-blue-300">Introduction</h2>
          ...
          <h2 className="text-3xl font-semibold text-blue-900 mb-2 dark:text-blue-300">Skills</h2>
          <p className="text-lg leading-relaxed mb-4 dark:text-gray-200">
          ...
          <h2 className="text-3xl font-semibold text-blue-900 mb-2 dark:text-blue-300">Why Frontend Development?</h2>
          <p className="text-lg leading-relaxed mb-4 dark:text-gray-200">
          ...
          <h2 className="text-3xl font-semibold text-blue-900 mb-2 dark:text-blue-300">Future Goals</h2>
