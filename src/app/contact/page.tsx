...
export default function Contact(){
  return (
    ...
    <div className="">
      <h1 className="text-4xl font-bold text-center mb-4 mt-24 underline text-cyan-300 animate-scale-up-down">Contact Me</h1>
        <div className="bg-blue-950 text-white min-h-screen flex items-center justify-center px-6">
